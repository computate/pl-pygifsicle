...
## --resize width 300 --rotate-180 --colors 30
...
![--resize width 300 --rotate-180 --colors 30 before](incoming/selfprogramming.gif)

After

![--resize width 300 --rotate-180 --colors 30 after](outgoing/selfprogramming.gif)
